...
class EndMarkerPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Caja Negra
    const Rect blackBox = Rect.fromLTWH(10, 20, 70, 80);
    ...
    //const String tempText = 'Jean Jaures 3225, Valentin Alsina, Buenos Aires, Argentina';
    ...
    locationPainter.paint(canvas, Offset(85, offsetY));
